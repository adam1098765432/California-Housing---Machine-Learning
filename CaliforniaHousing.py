...
# 5. Define an ANN model with BatchNorm and dropout
# Added BatchNorm1d layers before each Linear to stabilize distributions
input_dim = X_train_t.shape[1]
model = nn.Sequential(
    nn.BatchNorm1d(input_dim),   # normalize input batch
    nn.Linear(input_dim, 64),     # input to first hidden
    nn.ReLU(),
    nn.Dropout(0.1),              # regularization
    nn.BatchNorm1d(64),           # normalize hidden activations
...
# 12. Predicted vs Actual scatter
